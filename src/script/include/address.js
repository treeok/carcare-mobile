    ...
    var _address = {
        init:function(){
            ...
            $('#address-lists-add').click(function(){
                window.location.href = 'modifyaddress.html';
            });
        ...
        getAddressList:function(){
            ...
            Utils.ajaxJson(url, {}, function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    var item = data[i];
                    html += '<div class="address-list" data-value="' + item.id + '" style="background: #fff;border:1px solid #37bdd6;height:120px;">' +
                    '<div style="margin:0 15px;position:relative;top:15px;border-bottom:1px dashed #37bdd6;">' +
